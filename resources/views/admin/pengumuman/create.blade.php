        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <p class="mt-4">Halaman pembuatan pengumuman pada panel admin telah dinonaktifkan.</p>
...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-bold mb-4">Buat Pengumuman Baru</h1>
                    ...
                    <form action="{{ route('admin.pengumuman.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.pengumuman.index') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                                Batal
                            </a>
                        </div>
                    </form>
